...
import { Avatar, Chip, Icon, IconButton, Paper, Stack, Typography } from '@mui/material'
          ...
          <Stack alignItems="flex-start" mt={1}>
            <Stack direction="column" alignItems="flex-start" spacing={0.5}  mt={1}>
              ...
              <Stack direction='row' alignItems='center' spacing={0.4}>
                ...
                <IconButton size='small' sx={{ p: 0.4, backgroundColor: 'background.default' }} edge="end" aria-label="copiar">
                  <Icon sx={{ fontSize: 16 }}>content_copy</Icon>
                </IconButton>
                <IconButton size='small' sx={{ p: 0.4, backgroundColor: 'background.default' }} edge="end" aria-label="whastapp">
